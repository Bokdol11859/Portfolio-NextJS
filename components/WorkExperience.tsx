...
const Experience = ({ experiences }: Props) => {
  return (
    ...
    >
      ...
      <div className="w-full flex justify-center mt-[120px] space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#51abcb]/80">
